...
class OrganizationGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Organization entity")
        ...
        .repeat(2) {
            ...
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "lawman":"SAMPLE_TEXT", "orgCode":"SAMPLE_TEXT", "orgName":"SAMPLE_TEXT", "applyStatus":"SAMPLE_TEXT", "cityCode":"SAMPLE_TEXT", "provinceCode":"SAMPLE_TEXT", "countyCode":"SAMPLE_TEXT", "orgType":"SAMPLE_TEXT", "createBy":"SAMPLE_TEXT", "createDate":"2020-01-01T00:00:00.000Z"}""")).asJSON
            .check(status.is(201))
